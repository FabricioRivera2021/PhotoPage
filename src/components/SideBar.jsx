        ...
        <div className="w-40 h-screen flex flex-col justify-between items-start">
            ...
            <div className="mt-14 w-36 flex-1">
                ...
                <div className="flex flex-col flex-1 antialiased text-left mt-10">
                    ...
                    <NavLink className={({isActive}) => `nav-item nav-link ${isActive ? 'text-white bg-zinc-700 px-2 rounded-tr-lg transition-all' : 'text-white'}`} to="/paquetes" >(Paquetes disponibles)?</NavLink>
                </div>
            </div>
